...
class InvitationsControllerTest < ActionController::TestCase
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post :create, invitation: { business_id: @invitation.business_id, email: @invitation.email, name: @invitation.name }
    end
  ...
  test "should update invitation" do
    patch :update, id: @invitation, invitation: { business_id: @invitation.business_id, email: @invitation.email, name: @invitation.name }
    assert_redirected_to invitation_path(assigns(:invitation))
  end
